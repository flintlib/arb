...
static __inline__ void
acb_set_arb_arb(acb_t z, const acb_t re,const acb_t im)
{
    //Set the real and imaginary parts of z to re and im respectively.
    arb_set(acb_realref(z),re);
    arb_set(acb_realref(z),im);
}
