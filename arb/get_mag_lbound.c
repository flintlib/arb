...
/* TODO: document/test these functions; use correctly in sqrt/rsqrt etc. */
...
static __inline__ void
_arb_get_mag_infimum_lower(mag_t z, const arf_t mid, const mag_t rad)
{
...
void
arb_get_mag_infimum_lower(mag_t z, const arb_t x)
{
    _arb_get_mag_infimum_lower(z, arb_midref(x), arb_radref(x));
}
