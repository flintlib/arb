...
void
arb_sub(arb_t z, const arb_t x, const arb_t y, long prec)
{
    int inexact;
...
void
arb_sub_arf(arb_t z, const arb_t x, const arf_t y, long prec)
{
    int inexact;
...
void
arb_sub_ui(arb_t z, const arb_t x, ulong y, long prec)
{
    int inexact;
...
void
arb_sub_si(arb_t z, const arb_t x, long y, long prec)
{
    int inexact;
...
void
arb_sub_fmpz(arb_t z, const arb_t x, const fmpz_t y, long prec)
{
    int inexact;
