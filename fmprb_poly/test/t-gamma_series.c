...
int main()
{
    ...
    for (iter = 0; iter < 2000; iter++)
    {
        ...
        fmprb_poly_gamma_series(b, a, n1, rbits2);
        fmprb_poly_gamma_series(c, a, n2, rbits3);
        ...
        fmprb_poly_mullow(c, b, a, n1, rbits2);

        fmprb_poly_set(d, a);
        fmprb_add_ui(d->coeffs, d->coeffs, 1, rbits2);
        fmprb_poly_gamma_series(d, d, n1, rbits2);
        ...
        fmprb_poly_gamma_series(a, a, n1, rbits2);
