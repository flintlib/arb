...
int main()
{
    ...
    for (iter = 0; iter < 100000; iter++)
    {
        ...
        fmprb_poly_mullow(c, a, b, trunc, rbits3);
        ...
        fmprb_poly_set(d, a);
        fmprb_poly_mullow(d, d, b, trunc, rbits3);
        ...
        fmprb_poly_set(d, b);
        fmprb_poly_mullow(d, a, d, trunc, rbits3);
        if (!fmprb_poly_equal(d, c))
        {
        ...
        fmprb_poly_set(b, a);
        fmprb_poly_mullow(c, a, b, trunc, rbits3);
        fmprb_poly_mullow(d, a, a, trunc, rbits3);
        ...
        fmprb_poly_mullow(a, a, a, trunc, rbits3);
