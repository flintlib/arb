...
int main()
{
    ...
    for (iter = 0; iter < 2000; iter++)
    {
        ...
        fmprb_poly_rgamma_series(b, a, n1, rbits2);
        fmprb_poly_rgamma_series(c, a, n2, rbits3);
        ...
        fmprb_poly_rgamma_series(d, d, n1, rbits2);
        fmprb_poly_mullow(c, d, a, n1, rbits2);
        ...
        fmprb_poly_rgamma_series(a, a, n1, rbits2);
