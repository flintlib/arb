...
int main()
{
    ...
    for (iter = 0; iter < 1000; iter++)
    {
        ...
        fmpcb_poly_rgamma_series(b, a, n1, rbits2);
        fmpcb_poly_rgamma_series(c, a, n2, rbits3);
        ...
        fmpcb_poly_rgamma_series(d, d, n1, rbits2);
        fmpcb_poly_mullow(c, d, a, n1, rbits2);
        ...
        fmpcb_poly_rgamma_series(a, a, n1, rbits2);
