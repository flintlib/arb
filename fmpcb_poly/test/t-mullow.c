...
int main()
{
    ...
    for (iter = 0; iter < 10000; iter++)
    {
        ...
        fmpcb_poly_mullow(c, a, b, trunc, rbits3);
        ...
        fmpcb_poly_set(d, a);
        fmpcb_poly_mullow(d, d, b, trunc, rbits3);
        ...
        fmpcb_poly_set(d, b);
        fmpcb_poly_mullow(d, a, d, trunc, rbits3);
        if (!fmpcb_poly_equal(d, c))
        {
        ...
        fmpcb_poly_set(b, a);
        fmpcb_poly_mullow(c, a, b, trunc, rbits3);
        fmpcb_poly_mullow(d, a, a, trunc, rbits3);
        ...
        fmpcb_poly_mullow(a, a, a, trunc, rbits3);
    ...
    for (iter = 0; iter < 10000; iter++)
    {
        ...
        fmpcb_poly_mullow(ab2, a, b, trunc, bits);
