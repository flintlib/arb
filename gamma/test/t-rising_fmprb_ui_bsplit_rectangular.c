...
int main()
{
    ...
    printf("rising_fmprb_ui_bsplit_rectangular....");
    fflush(stdout);
    ...
    for (iter = 0; iter < 1000; iter++)
    {
        ...
        gamma_rising_fmprb_ui_bsplit_rectangular(b, a, n, step, 2 + n_randint(state, 1000));
    ...
    for (iter = 0; iter < 1000; iter++)
    {
        ...
        gamma_rising_fmprb_ui_bsplit_rectangular(x, x, n, step, prec);
