...
int main()
{
    ...
    for (iter = 0; iter < 1000; iter++)
    {
        ...
        gamma_rising_fmpcb_ui_bsplit(y, x, n, 2 + n_randint(state, 4000));
        gamma_rising_fmpcb_ui_bsplit(z, xn, m, 2 + n_randint(state, 4000));
        fmpcb_mul(y, y, z, 2 + n_randint(state, 4000));

        gamma_rising_fmpcb_ui_bsplit(z, x, n + m, 2 + n_randint(state, 4000));
    ...
    for (iter = 0; iter < 1000; iter++)
    {
        ...
        gamma_rising_fmpcb_ui_bsplit(y, x, n, prec);
        gamma_rising_fmpcb_ui_bsplit(x, x, n, prec);
