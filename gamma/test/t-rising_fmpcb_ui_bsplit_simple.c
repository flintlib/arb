...
int main()
{
    ...
    printf("rising_fmpcb_ui_bsplit_simple....");
    fflush(stdout);
    ...
    for (iter = 0; iter < 1000; iter++)
    {
        ...
        gamma_rising_fmpcb_ui_bsplit_simple(y, x, n, 2 + n_randint(state, 4000));
        gamma_rising_fmpcb_ui_bsplit_simple(z, xn, m, 2 + n_randint(state, 4000));
        fmpcb_mul(y, y, z, 2 + n_randint(state, 4000));

        gamma_rising_fmpcb_ui_bsplit_simple(z, x, n + m, 2 + n_randint(state, 4000));
    ...
    for (iter = 0; iter < 1000; iter++)
    {
        ...
        gamma_rising_fmpcb_ui_bsplit_simple(x, x, n, prec);
