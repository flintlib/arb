...
int main()
{
    ...
    printf("rising_fmpcb_ui_bsplit_rectangular....");
    fflush(stdout);
    ...
    for (iter = 0; iter < 1000; iter++)
    {
        ...
        gamma_rising_fmpcb_ui_bsplit_rectangular(y, x, n, step1, 2 + n_randint(state, 4000));
        gamma_rising_fmpcb_ui_bsplit_rectangular(z, xn, m, step2, 2 + n_randint(state, 4000));
        fmpcb_mul(y, y, z, 2 + n_randint(state, 4000));

        gamma_rising_fmpcb_ui_bsplit_rectangular(z, x, n + m, step3, 2 + n_randint(state, 4000));
    ...
    for (iter = 0; iter < 1000; iter++)
    {
        ...
        gamma_rising_fmpcb_ui_bsplit_rectangular(x, x, n, step, prec);
