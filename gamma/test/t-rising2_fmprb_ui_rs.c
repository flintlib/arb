...
int main()
{
    ...
    for (iter = 0; iter < 1000; iter++)
    {
        ...
        gamma_rising2_fmprb_ui_rs(u, v, a, n, 0, prec);
        ...
        fmprb_set(u2, a);
        gamma_rising2_fmprb_ui_rs(u2, v, u2, n, 0, prec);
        ...
        fmprb_set(v2, a);
        gamma_rising2_fmprb_ui_rs(u, v2, v2, n, 0, prec);
