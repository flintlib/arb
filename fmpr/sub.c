...
static void _fmpr_sub_special(fmpr_t z, const fmpr_t x, const fmpr_t y, long prec, fmpr_rnd_t rnd)
{
    if (fmpr_is_zero(x))
    {
        fmpr_neg_round(z, y, prec, rnd);
    }
...
fmpr_sub(fmpr_t z, const fmpr_t x, const fmpr_t y, long prec, fmpr_rnd_t rnd)
{
    ...
    {
        _fmpr_sub_special(z, x, y, prec, rnd);
        return;
    }
