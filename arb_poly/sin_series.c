...
void
_arb_poly_sin_series(arb_ptr g, arb_srcptr h, long hlen, long n, long prec)
{
    ...
    else
    {
        ...
        _arb_poly_sin_cos_series(g, t, h, hlen, n, prec);
        _arb_vec_clear(t, n);
    }
}

void
arb_poly_sin_series(arb_poly_t g, const arb_poly_t h, long n, long prec)
{
    long hlen = h->length;
