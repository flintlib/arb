...
int main()
{
    ...
    flint_printf("riemann_siegel_theta_series....");
    fflush(stdout);
    ...
    for (iter = 0; iter < 300 * arb_test_multiplier(); iter++)
    {
        ...
        arb_poly_riemann_siegel_theta_series(b, a, n1, rbits2);
        arb_poly_riemann_siegel_theta_series(c, a, n2, rbits3);
        ...
        arb_poly_neg(d, a);
        arb_poly_riemann_siegel_theta_series(c, d, n1, rbits2);
        arb_poly_neg(c, c);
