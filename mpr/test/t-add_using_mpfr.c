...
int main()
{
    ...
    for (iter = 0; iter < 100000; iter++)
    {
        ...
        mpr_randtest(x, state, b1);
        mpr_randtest(y, state, b2);
        ...
        error_exp = mpr_add_using_mpfr(z, x, y, b3, rnd);

        if (mpfr_add(v, t, u, rnd) == 0)
        {
        ...
        {
            /* check error bound */
            while (mpfr_add(v_exact, t, u, rnd) != 0)
